...
class Test_get_dict_value02(unittest.TestCase):
    ...
    def test_01(self):
        for i in range(10):
            ...
            ans = get_dict_value02(dictionary, key)

            msg = "get_dict_value02(%s, %s) returned %s." % (str(dictionary), str(key), str(ans))
