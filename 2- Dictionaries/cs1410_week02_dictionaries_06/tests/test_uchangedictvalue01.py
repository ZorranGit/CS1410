...
from uchangedictvalue01 import *
...
class Test_change_dict_value01(unittest.TestCase):
    ...
    def test_01(self):
        for i in range(10):
            ...
            ans = change_dict_value01(dictionary, key, new_value)

            msg = "change_dict_value01(%s, %s, %s) returned %s." % (str(dictionary), str(key), str(new_value), str(ans))
